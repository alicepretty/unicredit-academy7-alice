 ...
 */
package it.codeland.academy7.unicredit.alice.core.models;
...
import it.codeland.academy7.unicredit.alice.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "Unicredit/components/helloworld");
